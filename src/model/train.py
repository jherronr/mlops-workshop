...
wandb.login(key="ffd29c48227f2cf8a7aa1ca534baacef9c215875", relogin=True)
...
with wandb.init(project="EXPERIENCIAS", name=f"Train Model ExecId-{args.IdExecution}", job_type="train-model") as run:
    ...
    artifact = run.use_artifact("jherronr-universidad-eafit/EXPERIENCIAS/iris-tabular-standardized:latest", type="dataset")
